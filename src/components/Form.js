function Form(){
    ...
    <div class="container">
      <form class="form">
        <label>Waste/Circle</label><input type="text" />
        <br />
        <label>WULoss</label><input type="text" />
        <br />
        <label>WU Consumed</label><input type="text" />
        <br />
    ...
    <div class="container">
      <div>
        ...
        <form class="form">
          <label>Work Order 1</label><input type="text" />
          <br />
          <label>Work Order 2</label> <input type="text" />
          <br />
          <label>Work OrderS3</label><input type="text" />
          <br />
    ...
    <div class="container">
      ...
      <div class="block" >
        <label>Having an issue? Submit a ticket</label>
        <textarea name="error" id="" cols="30" rows="10"></textarea>
